...
class HARNN(nn.Module):
    ...
    def forward(self, input_x):
        ...
        return (scores, first_att_weight, first_visual, second_visual, third_visual),\
               (first_logits, second_logits, third_logits, global_logits, first_scores, second_scores)
